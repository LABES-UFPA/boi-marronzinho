                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 20.h),
                      Box('Itens', (){controller.onItensPressed();}),
                      SizedBox(height: 20.h),
                      Box('Contas Cadastradas', (){controller.onContasPressed();}),
                      SizedBox(height: 20.h),
                      Box('Trocar', (){controller.onTrocarProdutoPressed();}),
                      SizedBox(height: 20.h),
                      Box('Scannear Voucher', (){controller.onScannerPressed();}),
                      SizedBox(height: 20.h),
                      // Box('Localização', (){controller.onPontosPressed();}),
                      // SizedBox(height: 20.h),
                    ],
                  ),
                ),
