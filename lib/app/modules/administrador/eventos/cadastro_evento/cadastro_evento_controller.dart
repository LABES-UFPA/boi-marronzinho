...
class AddEventoController extends BaseController {
  ...
  final GlobalKey<FormState> registerEventoFormKey = GlobalKey<FormState>();
  final GlobalKey<FormState> endEventoFormKey = GlobalKey<FormState>();
  ...
  Future<void> onCadastroEvento() async {
