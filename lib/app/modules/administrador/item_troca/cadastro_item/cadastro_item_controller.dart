...
class AddItemController extends BaseController {
  ...
  final GlobalKey<FormState> endItemFormKey = GlobalKey<FormState>();
  ...
  Future<void> onCadastroItem() async {
    if (registerItemFormKey.currentState?.validate() ?? false) {
      ...
      try {
        ...
        // final registerItem = await TrocaReposity().cadastrarItem(
        //   nome: nomeController.text,
        //   descricao: descricaoController.text,
        //   precoBoicoins: precoBoicoins,
        //   precoReal: precoReais,
        //   dataItem: isoDate, // Usar data no formato ISO 8601
        //   limiteItem: int.tryParse(participantesController.text) ?? 20,
        //   imagem: imagem!,
